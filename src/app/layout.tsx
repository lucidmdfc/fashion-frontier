...
export const metadata = {
  ...
  icons: [
    ...
    { rel: 'icon', type: 'image/png', sizes: '16x16', url: '/favicon/F.png' },
    { rel: 'icon', type: 'image/png', sizes: '32x32', url: '/favicon/F.png' },
    { rel: 'apple-touch-icon', sizes: '180x180', url: '/favicon/F.png' },
  ],
};
