...
export const _review = [
  ...
  'A comprehensive guide to creating online courses. The step-by-step approach made it easy to follow and the examples were very relevant.',
  'This masterclass is a must for anyone looking to create an online course. The instructor was engaging and the content was very detailed.',
  'Very informative and well-presented. It covered all the aspects of course creation from start to finish. I feel much more confident now.',
  'An excellent course for beginners and advanced learners alike. The exercises were challenging but rewarding, and the instructor explained everything clearly.',
  'A fantastic course with practical examples. It covered both Python and R, which was very beneficial for understanding different approaches to machine learning.',
  'An amazing bundle of courses covering all aspects of digital marketing. Great value for money and very well taught.',
  'A great starting point for anyone new to SEO. The techniques shared were very practical and easy to implement.',
  'A comprehensive course that covers everything you need to know about digital marketing. The updates are a great addition to keep the content relevant.',
  'An excellent introduction to copywriting. The principles taught are fundamental and the examples help to understand the concepts better.',
  'Very insightful and up-to-date. It provides practical tips and strategies for writing compelling copy that converts.',
  'A treasure trove of copywriting secrets. The content is very actionable and the instructor shares valuable insights from their experience.',
  'Perfect for anyone looking to grow their Instagram. The strategies and tools shared are very effective and easy to implement.',
  'An excellent course for anyone interested in finance and algorithmic trading. The use of QuantConnect was particularly useful for practical application.',
];
